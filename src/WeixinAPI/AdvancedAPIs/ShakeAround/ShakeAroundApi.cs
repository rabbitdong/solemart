...
namespace Solemart.WeixinAPI.AdvancedAPIs.ShakeAround
{
    ...
    public static class ShakeAroundApi
    {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static DeviceSearchResultJson SearchDeviceById(string accessToken, List<DeviceApply_Data_Device_Identifiers> deviceIdentifiers, int timeOut = Config.TIME_OUT)
        {
            var data = new
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static DeviceSearchResultJson SearchDeviceByRange(string accessToken, int begin, int count, int timeOut = Config.TIME_OUT)
        {
            var data = new
            {
                begin = begin,
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static DeviceSearchResultJson SearchDeviceByApplyId(string accessToken, long applyId, int begin, int count, int timeOut = Config.TIME_OUT)
        {
            var data = new
            {
                apply_id = applyId,
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static SearchPages_Data_Page SearchPagesByPageId(string accessToken, long[] pageIds,
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static SearchPages_Data_Page SearchPagesByRange(string accessToken, int begin, int count,
            int timeOut = Config.TIME_OUT)
        {
            var data = new
            {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static GetShakeInfoResultJson GetShakeInfo(string accessToken, string ticket, int needPoi = 1,
            int timeOut = Config.TIME_OUT)
        {
        ...
        /// <param name="timeOut"></param>
        /// <returns></returns>
        public static StatisticsResultJson StatisticsByPage(string accessToken,
